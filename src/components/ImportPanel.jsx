      ...
      {step === 'idle' && (
        <>
          <p className="text-sm text-ink/70">
            Exporte ta bibliothèque depuis Libib (CSV) ou My Library (Excel),
            puis sélectionne le fichier ici. Rien n'est envoyé ailleurs que
            vers ta base : le fichier est lu directement dans ton navigateur.
            Tu peux réutiliser le même fichier plusieurs fois sans risque :
